package com.arifsupriyanto.a192102128_arifsupriyanto_recyclerviewb;
...
public class MahasiswaAdapter extends RecyclerView.Adapter<MahasiswaViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull MahasiswaViewHolder holder, int position)
    {
        ...
        holder._namaTextView.setText(mm.getNIM());
        holder._jkTextView.setText(mm.getNIM());

        String jp = mm.getJP();
        jp = jp.substring(0, 2); //hanya mengambul 2 karakter depan
